...
const WalletIcon : React.FC<SVGEelement> = ({ addClassName, color }) => {

    return (
        <svg className={addClassName} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 458.531 458.531">
            <g id="XMLID_830_">
                <g>
                    <g>
				...
				c16.969,0,30.725-13.756,30.725-30.726v-65.922c-0.622,0.029-1.247,0.048-1.876,0.048H336.688z" fill={color} />
				...
				C398.465,285.384,386.825,297.024,372.466,297.024z" fill={color}/>
                        <path d="M358.169,45.209c-6.874-20.806-29.313-32.1-50.118-25.226L151.958,71.552h214.914L358.169,45.209z" fill={color}/>
                    </g>
                </g>
            </g>
        </svg>
